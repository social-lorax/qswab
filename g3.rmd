...
# Goal 3: Support Community-Based Waste Reduction and Environmental Initiatives

```{r echo = FALSE}
read_csv("C:/Users/brenner/Downloads/qswab_goals.csv", locale=locale(encoding = "windows-1252")) %>% 
  filter(`Support Community-Based Waste Reduction and Environmental Initiatives`) %>% 
